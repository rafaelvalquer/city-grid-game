  ...
  if (tab === 'growth') {
    return (
      <>
        ...
        <ChartCard title="População desde o dia 1" samples={samples} series={[{ label: 'População', color: 'accent', values: samples.map((s) => s.population) }]} />
